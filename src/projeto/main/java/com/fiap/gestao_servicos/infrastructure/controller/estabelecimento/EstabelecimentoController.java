...
public class EstabelecimentoController {
    ...
    public ResponseEntity<Page<EstabelecimentoResponseDto>> listar(Pageable pageable) {
        Page<EstabelecimentoResponseDto> estabelecimentos = findAllEstabelecimentosUseCase.findAll(pageable)
    ...
    public ResponseEntity<Page<com.fiap.gestao_servicos.infrastructure.controller.estabelecimento.EstabelecimentoSearchResponseDto>> buscarComFiltros(
        ...
        Page<com.fiap.gestao_servicos.infrastructure.controller.estabelecimento.EstabelecimentoSearchResponseDto> resultado = findEstabelecimentosByCriteriaUseCase
