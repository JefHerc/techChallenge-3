...
public class EstabelecimentoEntity {
    ...
    public EstabelecimentoEntity(String nome, EnderecoEntity endereco, List<ProfissionalEntity> profissionais, List<ServicoEntity> servicos, String cnpj, List<String> urlFotos, List<HorarioFuncionamentoEmbeddable> horarioFuncionamento) {
        this.nome = nome;
