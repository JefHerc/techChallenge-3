...
public class AvaliacaoController {
    ...
    @GetMapping
        public ResponseEntity<Page<AvaliacaoResponseDto>> listar(@PathVariable Long agendamentoId,
                                     Pageable pageable) {
        findAgendamentoByIdUseCase.findById(agendamentoId);

        Page<AvaliacaoResponseDto> avaliacoes = findAllAvaliacoesUseCase.findByAgendamentoId(agendamentoId, pageable)
