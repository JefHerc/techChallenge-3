...
public class EstabelecimentoFilterDto {
    ...
    public Double getProfissionalNotaMinima() {
        return profissionalNotaMinima;
    }

    public void setProfissionalNotaMinima(Double profissionalNotaMinima) {
        this.profissionalNotaMinima = profissionalNotaMinima;
    }
